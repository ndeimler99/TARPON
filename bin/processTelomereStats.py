...
def main(args):
    ...
    vrr_fh.write("Sample_ID\tNumber_of_Reads\tMedian_Telomere_Length\tMean_VRR_Telomere_Length\tStandard_Deviation_VRR_Length\tQ1\tQ2\tQ3\tMin_VRR_Telo_Length\tMax_VRR_Telo_Length\tmin_qual\tmax_qual\tqual_q1\tqual_q2\tqual_q3\tmean_qual\n")
    ...
    for file in args.stat_files:
        ...
        vrr_fh.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(file.strip().split("/")[-1].split(".")[0], len(df['vrr_telo_length']), np.median(df['vrr_telo_length']), \
