...
process telogator_clustering {
    ...
    telogator2.py -i ${sample}.telo_trimmed.fasta -tt 0.1 --collapse-hom 500 -o ${sample}.clustering_results -r ont -l 0 -p 2 --filt-tel 0 --filt-nontel 10000 --filt-sub 0 --debug-noanchor
